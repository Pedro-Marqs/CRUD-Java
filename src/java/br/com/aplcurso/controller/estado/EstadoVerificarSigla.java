...
public class EstadoVerificarSigla extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            String siglaEstado = request.getParameter("siglaEstado").toUpperCase();
            ...
            System.out.println("Problemas no Servlet ao validar a sigla do estado! Erro: "+ ex.getMessage());
        }
    }
